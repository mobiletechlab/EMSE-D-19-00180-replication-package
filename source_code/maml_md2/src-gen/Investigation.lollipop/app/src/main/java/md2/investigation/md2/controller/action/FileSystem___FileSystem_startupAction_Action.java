...
public class FileSystem___FileSystem_startupAction_Action extends AbstractMd2Action {

    public FileSystem___FileSystem_startupAction_Action() {
		super("FileSystem___FileSystem_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new FileSystem___FileSystem_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new FileSystem___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new FileSystem_FileSystem_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var4 = new Md2BindTask(new FileSystem_FileSystem_getFileSystemValue_Action(), R.id.FileSystemView_160363, Md2WidgetEventType.ON_CLICK
			);
			var4.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var5 = new Md2BindTask(new FileSystem_FileSystem_done_Action(), R.id.FileSystemView_662844, Md2WidgetEventType.ON_CLICK
			);
			var5.execute();
		}catch (Md2WidgetNotCreatedException e){
