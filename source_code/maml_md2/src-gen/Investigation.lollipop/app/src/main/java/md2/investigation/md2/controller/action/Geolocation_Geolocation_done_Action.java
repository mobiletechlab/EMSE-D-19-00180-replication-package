...
public class Geolocation_Geolocation_done_Action extends AbstractMd2Action {

    public Geolocation_Geolocation_done_Action() {
		super("Geolocation_Geolocation_done_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("GeolocationDone"));
			var1.execute();
