...
public class FileSystem_FileSystem_done_Action extends AbstractMd2Action {

    public FileSystem_FileSystem_done_Action() {
		super("FileSystem_FileSystem_done_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("FileSystemDone"));
			var1.execute();
