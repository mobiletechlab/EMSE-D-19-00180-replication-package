...
import md2.investigation.md2.model.contentProvider.SensorProvider;
...
//import de.wwu.md2.android.md2library.model.dataStore.implementation.Md2LocalStoreFactory;
...
public class Controller extends AbstractMd2Controller {
    ...
    public void run() {
        ...
        Md2ViewManager.getInstance().setStartActivity("md2.investigation.StartActivity"); 
    }
    ...
    public void registerContentProviders() {
        ...
        LocationProvider locationProvider = new LocationProvider("LocationProvider", null, lsf.getDataStore("__ReturnStepStack")); //TODO store hack to avoid null pointer
        cpr.add("LocationProvider", locationProvider);
        SensorProvider sensorProvider = new SensorProvider("SensorProvider", null, lsf.getDataStore("__ReturnStepStack")); //TODO store hack to avoid null pointer
        cpr.add("SensorProvider", sensorProvider);
    }
