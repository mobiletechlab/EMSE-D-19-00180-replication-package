...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	public void onUpgrade(SQLiteDatabase sqliteDatabase, ConnectionSource connectionSource, int oldVer, int newVer) {
		try {
			...
			TableUtils.dropTable(connectionSource, InvestigationDatabase128.class, true);
			TableUtils.dropTable(connectionSource, InvestigationAccelerometer.class, true);
			TableUtils.dropTable(connectionSource, InvestigationCamera.class, true);
			TableUtils.dropTable(connectionSource, InvestigationDatabase128.class, true);
			TableUtils.dropTable(connectionSource, InvestigationDatabase2048.class, true);
			TableUtils.dropTable(connectionSource, InvestigationFileSystem.class, true);
			TableUtils.dropTable(connectionSource, InvestigationGeolocation.class, true);
			TableUtils.dropTable(connectionSource, __ReturnStepStack.class, true);
			TableUtils.dropTable(connectionSource, __ProcessChainControllerState.class, true);
