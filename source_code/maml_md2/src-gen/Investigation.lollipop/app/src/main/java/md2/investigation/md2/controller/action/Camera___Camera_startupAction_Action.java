...
public class Camera___Camera_startupAction_Action extends AbstractMd2Action {

    public Camera___Camera_startupAction_Action() {
		super("Camera___Camera_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Camera___Camera_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new Camera___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new Camera_Camera_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var4 = new Md2BindTask(new Camera_Camera_getCameraValue_Action(), R.id.CameraView_991226, Md2WidgetEventType.ON_CLICK
			);
			var4.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var5 = new Md2BindTask(new Camera_Camera_done_Action(), R.id.CameraView_634431, Md2WidgetEventType.ON_CLICK
			);
			var5.execute();
		}catch (Md2WidgetNotCreatedException e){
