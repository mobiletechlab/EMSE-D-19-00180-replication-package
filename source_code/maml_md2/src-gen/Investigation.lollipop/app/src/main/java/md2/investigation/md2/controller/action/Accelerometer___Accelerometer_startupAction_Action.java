...
public class Accelerometer___Accelerometer_startupAction_Action extends AbstractMd2Action {

    public Accelerometer___Accelerometer_startupAction_Action() {
		super("Accelerometer___Accelerometer_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Accelerometer___Accelerometer_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new Accelerometer___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new Accelerometer_Accelerometer_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var4 = new Md2BindTask(new Accelerometer_Accelerometer_getAccelerometerValue_Action(), R.id.AccelerometerView_446136, Md2WidgetEventType.ON_CLICK
			);
			var4.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var5 = new Md2BindTask(new Accelerometer_Accelerometer_done_Action(), R.id.AccelerometerView_259731, Md2WidgetEventType.ON_CLICK
			);
			var5.execute();
		}catch (Md2WidgetNotCreatedException e){
