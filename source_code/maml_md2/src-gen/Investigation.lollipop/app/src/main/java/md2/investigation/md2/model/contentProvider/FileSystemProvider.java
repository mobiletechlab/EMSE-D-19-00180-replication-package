...
public class FileSystemProvider extends AbstractMd2ContentProvider {

	public FileSystemProvider(String key, Md2Entity content, Md2DataStore md2DataStore) {
	...
	public Md2Type getValue(String attribute) {			
		switch (attribute){
			case "fileValue":
				if(((InvestigationFileSystem)content).getFileValue() != null){
					return  
						null; //TODO new Object (((InvestigationFileSystem)content).getFileValue());
				} else { return null;}
			default: return null;
		}
	}
...
break; // Avoid errors for unsupported type
	...
	public void newEntity(){
		content = new InvestigationFileSystem();
	}
}
