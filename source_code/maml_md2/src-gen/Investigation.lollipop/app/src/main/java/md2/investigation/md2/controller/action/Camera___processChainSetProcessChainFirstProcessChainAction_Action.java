...
public class Camera___processChainSetProcessChainFirstProcessChainAction_Action extends AbstractMd2Action {

    public Camera___processChainSetProcessChainFirstProcessChainAction_Action() {
		super("Camera___processChainSetProcessChainFirstProcessChainAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var2 = new Md2CallTask(new Camera___Camera_processChainExecuteStepAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
