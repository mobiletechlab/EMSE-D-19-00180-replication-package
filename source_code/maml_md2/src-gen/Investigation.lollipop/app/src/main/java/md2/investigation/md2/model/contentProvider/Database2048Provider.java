...
public class Database2048Provider extends AbstractMd2ContentProvider {

	public Database2048Provider(String key, Md2Entity content, Md2DataStore md2DataStore) {
	...
	public Md2Type getValue(String attribute) {			
		switch (attribute){
			case "databaseValue2048":
				if(((InvestigationDatabase2048)content).getDatabaseValue2048() != null){
					return  
						new Md2List<Md2String>
(((InvestigationDatabase2048)content).getDatabaseValue2048());	
				} else { return null;}
			default: return null;
		}
	}
	...
	public void setValue(String name, Md2Type value){
		...
		if ((this.getValue(name) == null && value != null) || value != null && !this.getValue(name).toString().equals(value.toString())) {
			switch (name){
				case "databaseValue2048":
					((InvestigationDatabase2048)content).setDatabaseValue2048(((
	...
	public void newEntity(){
		content = new InvestigationDatabase2048();
	}
}
