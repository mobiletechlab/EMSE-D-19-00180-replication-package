...
public class Accelerometer___processChainSetProcessChainFirstProcessChainAction_Action extends AbstractMd2Action {

    public Accelerometer___processChainSetProcessChainFirstProcessChainAction_Action() {
		super("Accelerometer___processChainSetProcessChainFirstProcessChainAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var2 = new Md2CallTask(new Accelerometer___Accelerometer_processChainExecuteStepAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
