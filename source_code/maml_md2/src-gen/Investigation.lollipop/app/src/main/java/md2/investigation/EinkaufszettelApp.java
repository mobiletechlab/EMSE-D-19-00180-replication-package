...
public class EinkaufszettelApp extends Application {
    ...
    public static BenchmarkFragment getBenchmarkFragment() {
        return benchmarkFragment;
    }

    public static void setBenchmarkFragment(BenchmarkFragment benchmarkFragment) {
        EinkaufszettelApp.benchmarkFragment = benchmarkFragment;
    }

    private static BenchmarkFragment benchmarkFragment;
    ...
    public static void setCurrentActivity(Activity currentActivity) {
        EinkaufszettelApp.currentActivity = currentActivity;
    }
