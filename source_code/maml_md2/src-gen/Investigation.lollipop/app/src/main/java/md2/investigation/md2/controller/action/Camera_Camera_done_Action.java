...
public class Camera_Camera_done_Action extends AbstractMd2Action {

    public Camera_Camera_done_Action() {
		super("Camera_Camera_done_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("CameraDone"));
			var1.execute();
