...
public class Geolocation___processChainSetProcessChainFirstProcessChainAction_Action extends AbstractMd2Action {

    public Geolocation___processChainSetProcessChainFirstProcessChainAction_Action() {
		super("Geolocation___processChainSetProcessChainFirstProcessChainAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var2 = new Md2CallTask(new Geolocation___Geolocation_processChainExecuteStepAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
