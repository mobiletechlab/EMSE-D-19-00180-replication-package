...
public class Camera___Camera_processChainProcessingAction_Action extends AbstractMd2Action {

    public Camera___Camera_processChainProcessingAction_Action() {
		super("Camera___Camera_processChainProcessingAction_Action"); 
	}
