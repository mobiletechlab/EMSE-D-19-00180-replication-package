...
public class Accelerometer_Accelerometer_done_Action extends AbstractMd2Action {

    public Accelerometer_Accelerometer_done_Action() {
		super("Accelerometer_Accelerometer_done_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("AccelerometerDone"));
			var1.execute();
