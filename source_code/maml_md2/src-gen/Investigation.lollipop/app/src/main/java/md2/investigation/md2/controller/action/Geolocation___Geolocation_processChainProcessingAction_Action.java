...
public class Geolocation___Geolocation_processChainProcessingAction_Action extends AbstractMd2Action {

    public Geolocation___Geolocation_processChainProcessingAction_Action() {
		super("Geolocation___Geolocation_processChainProcessingAction_Action"); 
	}
