...
public class Geolocation___Geolocation_startupAction_Action extends AbstractMd2Action {

    public Geolocation___Geolocation_startupAction_Action() {
		super("Geolocation___Geolocation_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Geolocation___Geolocation_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new Geolocation___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new Geolocation_Geolocation_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var4 = new Md2BindTask(new Geolocation_Geolocation_getGeolocationValue_Action(), R.id.GeolocationView_755859, Md2WidgetEventType.ON_CLICK
			);
			var4.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var5 = new Md2BindTask(new Geolocation_Geolocation_done_Action(), R.id.GeolocationView_893087, Md2WidgetEventType.ON_CLICK
			);
			var5.execute();
		}catch (Md2WidgetNotCreatedException e){
