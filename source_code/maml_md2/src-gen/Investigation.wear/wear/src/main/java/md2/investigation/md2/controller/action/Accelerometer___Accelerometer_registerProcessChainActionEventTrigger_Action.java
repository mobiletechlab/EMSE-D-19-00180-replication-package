...
public class Accelerometer___Accelerometer_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public Accelerometer___Accelerometer_registerProcessChainActionEventTrigger_Action() {
		super("Accelerometer___Accelerometer_registerProcessChainActionEventTrigger_Action"); 
	}
