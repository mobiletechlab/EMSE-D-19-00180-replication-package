...
public class Database___Database_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public Database___Database_registerProcessChainActionEventTrigger_Action() {
		super("Database___Database_registerProcessChainActionEventTrigger_Action"); 
	}
