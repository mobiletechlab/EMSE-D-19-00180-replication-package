...
public class Database___Database_processChainProcessingAction_Action extends AbstractMd2Action {

    public Database___Database_processChainProcessingAction_Action() {
		super("Database___Database_processChainProcessingAction_Action"); 
	}
