...
public class Database_Database_done_Action extends AbstractMd2Action {

    public Database_Database_done_Action() {
		super("Database_Database_done_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("DatabaseDone"));
			var1.execute();
