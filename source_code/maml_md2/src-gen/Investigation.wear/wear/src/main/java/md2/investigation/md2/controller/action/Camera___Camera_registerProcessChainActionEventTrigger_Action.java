...
public class Camera___Camera_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public Camera___Camera_registerProcessChainActionEventTrigger_Action() {
		super("Camera___Camera_registerProcessChainActionEventTrigger_Action"); 
	}
