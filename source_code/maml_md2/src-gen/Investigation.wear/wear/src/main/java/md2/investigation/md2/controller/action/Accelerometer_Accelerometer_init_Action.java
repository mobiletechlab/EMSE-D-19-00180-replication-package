...
public class Accelerometer_Accelerometer_init_Action extends AbstractMd2Action {

    public Accelerometer_Accelerometer_init_Action() {
		super("Accelerometer_Accelerometer_init_Action"); 
	}
