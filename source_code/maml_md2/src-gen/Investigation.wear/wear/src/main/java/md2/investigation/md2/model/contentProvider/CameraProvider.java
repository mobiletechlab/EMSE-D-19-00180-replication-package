...
public class CameraProvider extends AbstractMd2ContentProvider {

	public CameraProvider(String key, Md2Entity content, Md2DataStore md2DataStore) {
	...
	public Md2Type getValue(String attribute) {			
		switch (attribute){
			case "accelerometerValueX":
				if(((InvestigationCamera)content).getAccelerometerValueX() != null){
					return  
						new Object
						(((InvestigationCamera)content).getAccelerometerValueX());	
				} else { return null;}
			default: return null;
		}
	}
	...
	public void newEntity(){
		content = new InvestigationCamera();
	}
}
