...
public class Geolocation_Geolocation_init_Action extends AbstractMd2Action {

    public Geolocation_Geolocation_init_Action() {
		super("Geolocation_Geolocation_init_Action"); 
	}
