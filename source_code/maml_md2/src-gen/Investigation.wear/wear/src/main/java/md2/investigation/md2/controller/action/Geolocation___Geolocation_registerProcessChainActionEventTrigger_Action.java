...
public class Geolocation___Geolocation_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public Geolocation___Geolocation_registerProcessChainActionEventTrigger_Action() {
		super("Geolocation___Geolocation_registerProcessChainActionEventTrigger_Action"); 
	}
