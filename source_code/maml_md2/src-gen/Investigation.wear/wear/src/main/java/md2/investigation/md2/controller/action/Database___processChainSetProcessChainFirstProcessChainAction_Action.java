...
public class Database___processChainSetProcessChainFirstProcessChainAction_Action extends AbstractMd2Action {

    public Database___processChainSetProcessChainFirstProcessChainAction_Action() {
		super("Database___processChainSetProcessChainFirstProcessChainAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var2 = new Md2CallTask(new Database___Database_processChainExecuteStepAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
