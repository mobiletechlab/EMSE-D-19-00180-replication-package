...
@Expose
@DatabaseField(columnName = "databaseValue2048")
private String databaseValue2048;
	...
	public Md2Type get(String s) {
		...
		return new Md2String(getDatabaseValue2048());
		}
		return null;
	}
	...
	public void set(String s, Md2Type md2Type) {
		...
		case "databaseValue2048": 
		setDatabaseValue2048(((Md2String) md2Type).getPlatformValue();
		}
	}
...
public List<String> getDatabaseValue2048(){
	return new ArrayList<String>(this.databaseValue2048);
}	
