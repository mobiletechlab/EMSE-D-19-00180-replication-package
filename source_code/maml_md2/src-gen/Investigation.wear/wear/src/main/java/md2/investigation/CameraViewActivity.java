...
import md2.investigation.md2.controller.action.Camera_Camera_done_Action;

import de.wwu.md2.android.md2library.SensorHelper;


public class CameraViewActivity extends WearableActivity implements WearableActionDrawer.OnMenuItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		drawerLayout = (WearableDrawerLayout) findViewById(R.id.drawer_layout_CameraView);
...
if(actionDrawer.isPeeking()){
	...
	handler.postDelayed(new Runnable() {
		...
		navigationDrawer = (WearableNavigationDrawer) findViewById(R.id.navigation_drawer_CameraView);
		adapter = NavigationAdapter.getInstance();
		navigationDrawer.setAdapter(adapter);

		actionDrawer = (WearableActionDrawer) findViewById(R.id.bottom_action_drawer_CameraView);
	...
	public boolean onMenuItemClick(MenuItem menuItem) {
		...
		switch(itemId) {
			case R.id.CameraView_item0:
				ca = new Camera_Camera_getCameraValue_Action();
				break;

			case R.id.CameraView_item1:
				ca = new Camera_Camera_done_Action();
				break;
