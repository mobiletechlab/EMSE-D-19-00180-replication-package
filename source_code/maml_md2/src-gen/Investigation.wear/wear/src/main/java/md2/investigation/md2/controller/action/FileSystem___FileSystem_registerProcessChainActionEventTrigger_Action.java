...
public class FileSystem___FileSystem_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public FileSystem___FileSystem_registerProcessChainActionEventTrigger_Action() {
		super("FileSystem___FileSystem_registerProcessChainActionEventTrigger_Action"); 
	}
