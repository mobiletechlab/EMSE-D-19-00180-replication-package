...
public class InvestigationAccelerometer implements Serializable {
	...
	@NotNull
	@XmlElement(nillable=true)
	protected  accelerometerValueX;
	
	@NotNull
	@XmlElement(nillable=true)
	protected  accelerometerValueY;
	
	@NotNull
	@XmlElement(nillable=true)
	protected  accelerometerValueZ;
	...
	public  getAccelerometerValueX() {
		return accelerometerValueX;
	}
	
	public void setAccelerometerValueX( accelerometerValueX) {
		this.accelerometerValueX = accelerometerValueX;
	}
	
	public  getAccelerometerValueY() {
		return accelerometerValueY;
	}
	
	public void setAccelerometerValueY( accelerometerValueY) {
		this.accelerometerValueY = accelerometerValueY;
	}
	
	public  getAccelerometerValueZ() {
		return accelerometerValueZ;
	}
	
	public void setAccelerometerValueZ( accelerometerValueZ) {
