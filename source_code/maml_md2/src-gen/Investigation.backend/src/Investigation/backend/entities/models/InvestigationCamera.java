...
public class InvestigationCamera implements Serializable {
	...
	@NotNull
	@XmlElement(nillable=true)
	protected String accelerometerValueX;
	...
	public String getAccelerometerValueX() {
		return accelerometerValueX;
	}
	
	public void setAccelerometerValueX(String accelerometerValueX) {
